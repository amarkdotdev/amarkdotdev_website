...
export function FlagshipSection() {
  return (
    <section
      id="flagship"
      className="relative border-t border-white/[0.06] bg-gradient-to-b from-cyan-500/[0.06] to-transparent px-6 py-16 sm:px-8 sm:py-20 md:px-10 md:py-24"
    >
      <div className="mx-auto w-full max-w-6xl">
        <Reveal>
          <div className="rounded-3xl border border-cyan-200/20 bg-white/[0.04] p-6 shadow-card-inner backdrop-blur-md sm:p-8 md:p-10">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              ...
              <div className="shrink-0 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-center">
